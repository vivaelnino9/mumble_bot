...
class CallBacks(dict):
    ...
    def __init__(self):
        self.update({
            constants.PYMUMBLE_CLBK_CONNECTED: None,  # Connection succeeded
            constants.PYMUMBLE_CLBK_CHANNELCREATED: None,  # send the created channel object as parameter
            constants.PYMUMBLE_CLBK_CHANNELUPDATED: None,  # send the updated channel object and a dict with all the modified fields as parameter
            constants.PYMUMBLE_CLBK_CHANNELREMOVED: None,  # send the removed channel object as parameter
            constants.PYMUMBLE_CLBK_USERCREATED: None,  # send the added user object as parameter
            constants.PYMUMBLE_CLBK_USERUPDATED: None,  # send the updated user object and a dict with all the modified fields as parameter
            constants.PYMUMBLE_CLBK_USERREMOVED: None,  # send the removed user object and the mumble message as parameter
            constants.PYMUMBLE_CLBK_SOUNDRECEIVED: None,  # send the user object that received the sound and the SoundChunk object itself
            constants.PYMUMBLE_CLBK_TEXTMESSAGERECEIVED: None,  # Send the received message
            constants.PYMUMBLE_CLBK_CONTEXTACTIONRECEIVED: None,  # Send the contextaction message
        })
