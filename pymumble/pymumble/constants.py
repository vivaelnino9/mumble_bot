...
PYMUMBLE_VERSION_STRING = 'PyMumble {}'.format(PYMUMBLE_VERSION)
PYMUMBLE_OS_STRING = 'PyMumble {}'.format(PYMUMBLE_VERSION)
PYMUMBLE_OS_VERSION_STRING = 'Python {} - {} {}'.format(sys.version,
                                                        platform.system(),
                                                        platform.release())
